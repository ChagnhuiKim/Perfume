...
class ExpSurveyPage extends Component<ExpSurveyPageProps> {
  ...
  initializeFamousInfo = async () => {
    await axios
      .get(
        `http://i02b208.p.ssafy.io:3194/perfumes/famous/?gender=${this.props.location.state}`
      )
      .then((r) => {
          ...
          <section style={{ marginTop: 80 }} >
            ...
            <div className="exp-survey-result">
              {this.state.result.map((r) => (
                <Link to={`/detail/${r}`}>
                <div style={{backgroundImage: `url(http://i02b208.p.ssafy.io:3194/staticfiles/images/${r}.jpg)`}}>
                  </div>
